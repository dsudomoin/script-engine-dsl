...
/**
 * Ограничитель DSL. Без него receiver [MigrationBuilder] остаётся видимым внутри лямбд стадии,
 * и стадию можно зарегистрировать прямо во время исполнения другой — то есть мутировать уже
 * построенный план. С маркером такой вызов не компилируется.
 */
@DslMarker
